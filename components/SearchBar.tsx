...
const SearchBar = () => {
    ...
    const SearchButton=({othercClasses}:{othercClasses:string})=>(
      <button type='submit' className={`ml-3 y-10 ${othercClasses}`}>
  ...
  return (
    <form className='searchbar' onSubmit={handleSearch}>
        <div className='searchbar__item'>
            ...
            <SearchButton othercClasses="sm:hidden"/>
        </div>
        <div className="searchbar__item">
        ...
        <SearchButton othercClasses="max-sm:hidden"/>
    </form>
  )
}
